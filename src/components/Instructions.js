// Instructions Page to help players start playing and know the rules
import '../index.css'
  ...
  return (
    <>
        <div className="instructions-container px-3 pt-5">
            ...
            <p className='pb-3'>1. <em>Start the Game</em>: Begin by pressing START"</p>
            <p className='pb-3'>2. <em>Choose a Word</em>: The wordsetter thinks of a word. They keep the word secret from the guesser.</p>
            <p className='pb-3'>3. <em>Set Up the Board</em>: An empty gallows gets drawn on the canvas for you.</p>
